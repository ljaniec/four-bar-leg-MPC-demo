...
CBF opisują zbiór stanów dopuszczalnych i narzucają warunek, aby sterowanie nie wypchnęło układu poza ten zbiór.
\end{block}
...
{\scriptsize CBF nie musi uczyć chodu. Ma zabronić sterowania, które prowadzi w konfiguracje zbyt szerokie, osobliwe albo bez zapasu momentu. CBF to język do opisu bezpieczeństwa, a nie magiczna gwarancja bez dobrze zdefiniowanego modelu i zbioru bezpiecznego.}
\end{block}
...
To slajd do dyskusji technicznej, nie jest potrzebny każdemu odbiorcy w głównej narracji.
\end{block}
