...
\end{center}
\end{columns}
\source{Opis z KKR: cztery kończyny, 3 stopnie swobody na kończynę, ROS 2, CAN, tryby sterowania napędów.}
...
\begin{itemize}
  ...
  \item Sterowanie z komputera przez Robot Operating System 2 (ROS 2) i Controller Area Network (CAN).
\end{itemize}
\column{0.42\textwidth}
\begin{figure}
  \centering
  \includegraphics[width=0.59\textwidth]{figures/robot-kkr-a.png}
  \includegraphics[width=0.49\textwidth]{figures/robot-kkr-b.png}
  \includegraphics[width=0.59\textwidth]{figures/robot-kkr-c.png}
\end{figure}
\end{columns}
