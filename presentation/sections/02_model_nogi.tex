% 7
\begin{frame}{Jedna noga jako pierwszy model badawczy dla MPC i robotów kroczących}
...
\]
\end{block}
\begin{block}{Domknięcie równoległoboku: współrzędne bierne}
\[
...
\begin{tikzpicture}[scale=0.82]
  ...
  \node[font=\scriptsize,align=center] at (2.6,1.35) {bezpiecznie};
  \node[font=\scriptsize,align=center,warn] at (2.8,0-0.4) {za blisko\\złej konfiguracji};
\end{tikzpicture}
\end{center}
\begin{itemize}
