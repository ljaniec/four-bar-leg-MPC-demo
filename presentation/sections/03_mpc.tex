...
\end{itemize}
\end{columns}
\note{Dla laików najważniejsza jest intuicja: MPC nie układa pełnego ruchu raz na zawsze. W tym demonstratorze stale rozwiązuje problem dojścia do jednego stałego punktu zadanego.}
\end{frame}
...
\end{itemize}
\begin{alertblock}{Precyzyjna klasyfikacja}
To jest \textbf{regulacja punkt--punkt}. Nie jest to śledzenie trajektorii ani śledzenie ścieżki.
\end{alertblock}
