...
\end{itemize}
Sterowanie predykcyjne potrzebuje modelu użytecznego dla horyzontu predykcji, nie kompletnego cyfrowego bliźniaka.
\end{columns}
...
\vspace{3pt}
MPC nie układa pełnej trasy raz na zawsze. Cały czas planuje krótki horyzont i wykonuje pierwszy element planu.
...
\begin{block}{Model \textit{kinematyczny} użyty w kodzie}
\[
