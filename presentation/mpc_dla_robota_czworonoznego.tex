...
\subtitle{Od modelu jednej nogi do bezpiecznej architektury sterowania}
\author{Łukasz Janiec}
\date{2026}

\begin{document}

\input{sections/01_wprowadzenie.tex}
\input{sections/02_model_nogi.tex}
\input{sections/03_mpc.tex}
\input{sections/04_lokomocja.tex}
\input{sections/05_bezpieczenstwo_i_appendix.tex}
